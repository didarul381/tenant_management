<div class="card-body">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show" id="summery" role="tabpanel" aria-labelledby="projectSummary">
...
<div class="tab-pane fade active" id="projectTask" role="tabpanel" aria-labelledby="pTask">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div>

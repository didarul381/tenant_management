        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @can('manage_users')
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-4">
                            {{ Form::label('office_time', __('Office Time').':') }}<span class="required">*</span>
                            <div class="row">
                                <div class="col-sm-6">
                                    {{ Form::time('office_from_time', '11:00', ['class' => 'form-control', 'id' => 'officeFromTime', 'required']) }}
                                </div>
                                <div class="col-sm-6">
                                    {{ Form::time('office_to_time', '19:00', ['class' => 'form-control', 'id' => 'officeToTime', 'required']) }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    @endif
                    <!-- Departments Single-Select (6 columns) -->
                   <div class="form-group col-sm-4 user-department">
                       {{ Form::label('department_id', __('messages.user.department').':') }}
                       {{ Form::select('department_id', $departments, null, ['class' => 'form-control', 'id' => 'departmentId', 'placeholder' => __('Select Department'), 'tabindex' => "7"]) }}
                   </div>
                   <div class="form-group col-sm-4">
                    ...
                    @endphp
                     <div class="form-group col-sm-4">
                        {{ Form::label('weekly_holidays', __('Weekly Holidays').':') }}<span class="required">*</span>
                         {{ Form::select('weekly_holidays[]', $weekly_holidays, [1], ['class' => 'form-control', 'id' => 'weeklyHolidays', 'multiple'=>true, 'tabindex' => "6"]) }}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-6">
                        <div class="form-group ">
                            ...
                            <label class="custom-switch pl-0 d-block">
                                <input type="checkbox" name="hold_account" class="custom-switch-input" value="1"
                                       tabindex="10">
                                <span class="custom-switch-indicator"></span>
                            </label>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            {{ Form::label('joining_date', __('Joining Date').':') }}<span class="required">*</span>
                            {{ Form::text('joining_date', null, ['class' => 'form-control', 'id' => 'joiningDate', 'placeholder' => 'Select Joining Date', 'required', 'tabindex' => "12"]) }}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            <label class="custom-switch pl-0 d-block">
                                <input type="checkbox" name="has_bank_info" class="custom-switch-input" id="hasBankInfo" value="1" tabindex="11">
                                <span class="custom-switch-indicator"></span>
                ...
                <div id="bankInfoFields" style="display: none;">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            {{ Form::label('bank_name', 'Bank Name:') }}<span class="bank-required" style="color: red; font-weight: bold;">*</span>
                            {{ Form::text('bank_name', null, ['id'=>'bank_name','class' => 'form-control bank-field', 'tabindex' => "12"]) }}
                        </div>
                        <div class="form-group col-sm-6">
                            {{ Form::label('account_name', 'Account Name:') }}<span class="bank-required" style="color: red; font-weight: bold;">*</span>
                            {{ Form::text('account_name', null, ['id'=>'account_name','class' => 'form-control bank-field', 'tabindex' => "13"]) }}
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            {{ Form::label('account_number', 'Account Number:') }}<span class="bank-required" style="color: red; font-weight: bold;">*</span>
                            {{ Form::text('account_number', null, ['id'=>'account_number','class' => 'form-control bank-field', 'tabindex' => "14"]) }}
                        </div>
                        <div class="form-group col-sm-6">
                            {{ Form::label('branch_name', 'Branch Name:') }}<span class="bank-required" style="color: red; font-weight: bold;">*</span>
                            {{ Form::text('branch_name', null, ['id'=>'branch_name','class' => 'form-control bank-field', 'tabindex' => "15"]) }}
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            {{ Form::label('branch_routing_number', 'Branch Routing Number:') }}<span class="bank-required" style="color: red; font-weight: bold;">*</span>
                            {{ Form::text('branch_routing_number', null, ['id'=>'branch_routing_number','class' => 'form-control bank-field', 'tabindex' => "16"]) }}
                        </div>
                        <div class="form-group col-sm-6">
                            {{ Form::label('swift_code', 'Swift Code:') }}
                            {{ Form::text('swift_code', null, ['id'=>'swift_code','class' => 'form-control bank-field', 'tabindex' => "17"]) }}
                        </div>
                    </div>
                </div>
                
                <div class="text-right">
                    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'btnSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing...", 'tabindex' => "18"]) }}

...
@section('content')
    <section class="section">
        <script>
            window.earliestProjectDate = "{{ $earliestProjectDate ? \Carbon\Carbon::parse($earliestProjectDate)->toISOString() : '' }}";
        </script>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div id="kpi_range" class="time_range">
                                    <i class="far fa-calendar-alt" aria-hidden="true"></i>&nbsp;&nbsp;
                                    <span></span> <b class="caret"></b>
                                </div>
                            </div>
                            <div id="kpi-loader" class="text-center my-2 d-none">
                                <i class="fa fa-spinner fa-spin fa-2x"></i>
                            </div>
                            <div class="row" id="kpi-cards">
                                <div class="col-xl-3 col-md-3 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Onboarded Job</div><h5 id="kpi-total-onboarded">0</h5></div></div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total In-Active Job</div><h5 id="kpi-total-inactive">0</h5></div></div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Ongoing Job</div><h5 id="kpi-total-ongoing">0</h5></div></div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Paid Job</div><h5 id="kpi-total-paid-jobs">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Due Job</div><h5 id="kpi-total-due-jobs">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Paid Amount</div><h5 id="kpi-total-paid-amount">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Due Amount</div><h5 id="kpi-total-due-amount">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Employee</div><h5 id="kpi-total-employees">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total Active Employee</div><h5 id="kpi-total-active-employees">0</h5></div></div>
                                </div>
                                <div class="col-xl-4 col-md-4 col-sm-6 mb-3">
                                    <div class="card shadow-sm"><div class="card-body"><div class="text-muted">Total In-Active Employee</div><h5 id="kpi-total-inactive-employees">0</h5></div></div>
                                </div>
                            </div>
                        </div>
                    </div>

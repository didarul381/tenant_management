...
@section('title')
    {{ __('messages.lead_stages.new_lead_stage') }}
@endsection
...
@section('content')
    <section class="section">
        ...
        <div class="section-header">
            <h1 class="page__heading">{{ __('messages.lead_stages.new_lead_stage') }}</h1>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => 'lead-stages.store', 'method' => 'post', 'class' => 'lead-stage-form']) }}

...
<div class="row">
    <div class="form-group col-sm-12">
        ...
        {{ Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'required', 'placeholder' => __('messages.lead_sources.name')]) }}
    </div>

    <div class="form-group col-sm-12">
        {{ Form::label('description', __('messages.lead_sources.description').':') }}
        {{ Form::textarea('description', null, ['class' => 'form-control', 'id' => 'description', 'rows' => 3, 'placeholder' => __('messages.lead_sources.description')]) }}
    </div>

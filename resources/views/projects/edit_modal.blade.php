            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        {{ Form::text('domain_name', $project->domain_name ?? '', ['id'=>'edit_domain_name','class' => 'form-control']) }}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        {{ Form::select('job_type', ['' => 'Select Job Type'] + ($jobTypes ?? []), null, ['id' => 'edit_job_type', 'class' => 'form-control']) }}
                    </div>
                </div>

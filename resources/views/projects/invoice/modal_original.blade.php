        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pi_received_from" value="{{ $project->name }} ({{ $project->client->name }})" readonly>
                </div>
                <div class="form-group">
                    {{ Form::label('amount', 'Amount:') }}
                    <div class="input-group">
                        <div class="input-group-prepend"><div class="input-group-text"><i class="{{ \App\Models\Project::getCurrencyClass($project->currency) }}"></i></div></div>
                        <input type="text" class="form-control" id="pi_amount_display" value="{{ number_format($project->price) }}" readonly>
                    </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    {{ Form::label('in_word', 'In Word / Description:') }}

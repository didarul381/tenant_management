        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        {{ Form::label('domain_name', __('messages.project.domain_name').':') }}
                        {{ Form::text('domain_name', null, ['id'=>'domain_name','class' => 'form-control','autocomplete' => 'off']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 col-md-6">
                    ...
                    <div class="form-group col-sm-12 col-md-4">
                        ...
                        @if(auth()->user()->can('manage_clients'))
                            <div class="input-group flex-nowrap">
                                {{ Form::select('client_id', $clients, null, ['id'=>'client_id','class' => 'form-control', 'placeholder' => 'Select Employee', 'required']) }}
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        {{ Form::select('job_type', ['' => 'Select Job Type'] + ($jobTypes ?? []), null, ['id' => 'job_type', 'class' => 'form-control']) }}
                    </div>
                </div>

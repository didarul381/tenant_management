...
@section('title')
    {{ __('leave_requests.new_leave_request') }}
@endsection
...
<section class="section">
    ...
    <div class="section-header">
        <h1 class="page__heading">{{ __('leave_requests.new_leave_request') }}</h1>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ Form::open(['route' => 'leave-requests.store', 'method' => 'post', 'class' => 'leave-request-form', 'enctype' => 'multipart/form-data']) }}

            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 task-tags">
                        ...
                        {{ Form::select('tags[]',[], null, ['class' => 'form-control','id'=>'editTagIds', 'multiple' => false]) }}
                    </div>
                </div>
                <div class="row">

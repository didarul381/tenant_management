                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            {{ Form::number('estimate_time_minutes', null, ['id' => 'estimateTimeMinutes', 'class' => 'form-control', 'autocomplete' => 'off','min' => 0 ,'max' => 59]) }}
                            {{ Form::text('estimate_time_hours', null, ['id'=>'estimateTimeHours','class' => 'form-control estimateTime', 'autocomplete' => 'off']) }}
                            ...
                            <div class="input-group-append">
                                <input type="hidden" name="estimate_time_type" value="2" id="types">
                                <button name="type" type="button" class="input-group-text btn btn-primary text-white" id="Minutes" value="2">{{"Minutes"}}</button>
                                <button name="type" type="button" class="input-group-text btn"
                                        id="Days">{{__('messages.task.in_days')}}</button>
                                <button name="type" type="button" class="input-group-text btn"
                                        id="Hours">{{__('messages.task.in_hours')}}</button>
                            </div>
                        </div>
                    </div>

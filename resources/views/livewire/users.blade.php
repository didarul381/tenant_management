<div class="row">
    <div class="mt-0 mb-3 col-12 d-flex justify-content-end align-items-start flex-wrap">
        @if($totalUsers != 0)
            <div class="pr-0 pl-2 pt-2 pb-2 mr-2">
              
                <select class="form-control" wire:model="departmentId">
                    <option value="">All Departments</option>
                    <option value="none">Non Departmental</option>

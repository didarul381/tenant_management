...
mix.js('resources/assets/js/custom.js', 'public/assets/js/custom.js').
    ...
    js('resources/assets/js/lead_sources/lead_source.js',
        'public/assets/js/lead_sources/lead_source.js').
    js('resources/assets/js/lead_stages/lead_stage.js',
        'public/assets/js/lead_stages/lead_stage.js').
    js('resources/assets/js/leads/leads.js',
        'public/assets/js/leads/leads.js').
    js('resources/assets/js/leave_requests/leave_requests.js',
        'public/assets/js/leave_requests/leave_requests.js').
    js('resources/assets/js/absents/absents.js',
        'public/assets/js/absents/absents.js').
    js('resources/assets/js/callrecords/callrecords.js',
        'public/assets/js/callrecords/callrecords.js').
    js('resources/assets/js/report/task_report.js',
        'public/assets/js/report/task_report.js').
    ...
    js('resources/assets/js/job-status/job-status.js',
        'public/assets/js/job-status/job-status.js').
    js('resources/assets/js/job-type/job-type.js',

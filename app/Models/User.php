...
class User extends Authenticatable implements MustVerifyEmail, HasMedia
{
 ...
 const DEVELOPER = 'Developer';
    ...
    public static $rules = [
        ...
        'hold_account' => 'nullable',
        'joining_date' => 'required|date',
        'office_from_time' => 'required',
        'office_to_time' => 'required',
        'weekly_holidays' => 'required|array',
         // Bank Info Rules (All nullable by default)
        'bank_name' => 'nullable|string|max:255',
        'account_name' => 'nullable|string|max:255',
        'account_number' => 'nullable|string|max:255|unique:users,account_number',
        'branch_name' => 'nullable|string|max:255',
        'branch_routing_number' => 'nullable|string|max:255',
    ...
    public function department()
    {
        return $this->belongsTo(Department::class, 'department_id'); // 'department_id' is the foreign key in users table
    }

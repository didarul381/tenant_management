...
class Project extends Model implements HasMedia
{
    ...
    const STATUS_BADGE = [
        ...
        self::STATUS_PAID => 'badge-secondary',
    ];
    ...
    protected $casts = [
        ...
        'domain_name' => 'string',
        'job_type' => 'integer',
        'is_digital_marketing' => 'boolean',
        'is_ecommerce_saas' => 'boolean',
        'is_custom_software' => 'boolean',
        'is_in_house_development' => 'boolean',
    ];
    ...
    {
        return $this->hasMany(ProjectsInvoice::class, 'project_id');
    }
    ...
    public function projectProgress()
    {
        ...
        if ($completedTasks->count() != 0) {
            ...
            $totalProgrss = $completedTasks->count() * 100 / $this->tasks->count();
         
            // if ($totalProgrss == 100 && $this->status != 2) {
            //     Project::where('id', $this->id)->update(['status' => 2]);
            // } elseif($totalProgrss < 100 && $this->status == 2) {
            //     Project::where('id', $this->id)->update(['status' => 1]);
            // }
    ...
    {
        return $this->belongsTo(JobStatus::class, 'status', 'id');

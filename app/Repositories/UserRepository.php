...
class UserRepository extends BaseRepository
{
     ...
     public function store($input)
    {
        ...
        // Handle bank info - only store if has_bank_info is checked
         if (!isset($input['has_bank_info']) || $input['has_bank_info'] != '1') {
                // If not checked, set all bank fields to null
                $input['bank_name'] = null;
                $input['account_name'] = null;
                $input['account_number'] = null;
                $input['branch_name'] = null;
                $input['branch_routing_number'] = null;
                $input['swift_code'] = null;
         }

        // Handle weekly holidays - convert array to JSON
        if (isset($input['weekly_holidays']) && is_array($input['weekly_holidays'])) {
            $input['weekly_holidays'] = json_encode($input['weekly_holidays']);
        }
    ...
    public function validateInput($input)
    {
        ...
        $input['hold_account'] = (! empty($input['hold_account'])) ? 1 : 0;
